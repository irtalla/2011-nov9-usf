...
//let swResults = document.querySelector('#results');
let queryType = Form['mathtype'].value;
...
function getData() {
    ...
    //xhttp.open('GET', apiURL + '' + userInput+'/'+form+'?json');
    xhttp.open('GET', apiURL + '' + userInput+'/trivia?json');
