...
//var apiURL = 'https://age-of-empires-2-api.herokuapp.com/api/v1/civilization/';
var apiURL = 'https://pokeapi.co/api/v2/pokemon/';
var namediv=document.getElementById('1');
...
function populateData(response) {
    ...
    var nameTag=document.createElement('h3');
    var experiece=document.createElement('h4');
    nameTag.innerHTML=capitalize(response.name);
    experiece.innerHTML=response.base_experience;
    ...
    dataSection.innerHTML+= 'Hp';
    dataSection.appendChild(experiece);
