...
class OfferServicesTest {
	...
	void updateOfferTest() {
		...
		assertTrue(o3.getBicycle().getBicycleType().getId() == 8);
		assertTrue(o3.getBicycle().getBicycleType().getManufacturer().equals("Polygon"));
		assertTrue(o3.getBicycle().getBicycleType().getModel().equals("Cascade 4"));
