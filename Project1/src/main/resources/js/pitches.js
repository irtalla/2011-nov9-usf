...
function loggedAuthorRemainingPoints(){
    return 100 - loggedUser.pitches.reduce((sum, pitch) => sum += pitch.storyType.points);
}
...
async function addPitch(){
    ...
    newPitch["status"] = loggedAuthorRemainingPoints > 0 ? "PENDING" : "SAVED";
