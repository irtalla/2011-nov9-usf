...
public class ProductPostgres implements ProductDAO {
	...
	private Pitch deserializeProduct(ResultSet rs) throws SQLException {
		
		Pitch returnedProduct = new Pitch(); 
	...
	public Set<Pitch> getAvailableProducts() {
		...
		Set<Pitch> availableProducts = new HashSet<Pitch>();
